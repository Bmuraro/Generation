package projetoLojaDeGames.LojaDeGames.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("projetoLojaDeGames.LojaDeGames.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/Bmuraro")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Bruno Muraro", 
			"https://github.com/Bmuraro", 
			"bmuraro3@gmail.com");
